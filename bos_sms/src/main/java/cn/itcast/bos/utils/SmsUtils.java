...
public class SmsUtils {
	...
	static final String accessKeyId = "LTAIqXXTJu9HaTlu";
	static final String accessKeySecret = "IoyOdeJHO02wykJcuzECnoECYiC50U";
	...
	public static SendSmsResponse sendSms(String telephone, String randomCode) throws ClientException {
		...
		// 必填:短信签名-可在短信控制台中找到
		request.setSignName("李鹏");
		// 必填:短信模板-可在短信控制台中找到
		request.setTemplateCode("SMS_140110684");
	...
	public static void main(String[] args) throws ClientException, InterruptedException {
		...
		// 发短信
		SendSmsResponse response = sendSms("18956068569", "123456");
		...
		if (response.getCode() != null && response.getCode().equals("OK")) {
			QuerySendDetailsResponse querySendDetailsResponse = querySendDetails("18956068569",response.getBizId());
